...
return {
  ...
  dependencies = {
    "williamboman/mason.nvim",  -- Optional, for easy LSP management
  ...
  config = function()
    ...
    -- Mason-LSPconfig setup (optional)
    require("mason-lspconfig").setup({
      ensure_installed = { "pyright", "clangd" },  -- Automatically install pyright and clangd
    })
